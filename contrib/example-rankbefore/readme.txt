...
In this example, it is demonstrated how to use this extension to add a second rank to your profile, and show it in 
most relevant places.

This is intended to be positioned BEFORE the standard rank, and it loads any of the images in the images/ranks folder
